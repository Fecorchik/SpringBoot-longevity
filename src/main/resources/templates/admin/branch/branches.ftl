                                    ...
                                    <table id="example_1" class="display dataTable no-footer" style="width: 100%;"
                                        ...
                                        <tr role="row" style="background-color: var(--light-bg-color);">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                ...
                                                style="width: 456px;">Branch Name
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Joining date: activate to sort column ascending"
                                                style="width: 222px;">Monday
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Emp. Status: activate to sort column ascending"
                                                style="width: 241px;">Tuesday
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Emp. Status: activate to sort column ascending"
                                                style="width: 241px;">Wednesday
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Emp. Status: activate to sort column ascending"
                                                style="width: 241px;">Thursday
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Emp. Status: activate to sort column ascending"
                                                style="width: 241px;">Friday
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Emp. Status: activate to sort column ascending"
                                                style="width: 241px;">Saturday
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Emp. Status: activate to sort column ascending"
                                                style="width: 241px;">Sunday
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                colspan="1" aria-label="Emp. Status: activate to sort column ascending"
                                        ...
                                        <#list branches as branche>
                                            <tr role="row" class="odd" style="border-bottom: 2px solid #E7EDF6;">
                                                <td class="sorting_1" style="padding: 8px 10px;"
                                                    text="${branche.getId()}">${branche.getId()}</td>
                                                <td style="padding: 8px 10px;"
                                                    text="${branche.getName()}">${branche.getName()}</td>
                                                <#list branche.getWorkSchedule() as work>
                                                    <td style="padding: 8px 10px;">
                                                        <input type="time" name="${work.getDay()}.start"
                                                               value="${work.getTimeStartWork()}" readonly>
                                                        <input type="time" name="${work.getDay()}.end"
                                                               value="${work.getTimeEndWork()}" readonly>
                                                    </td>
                                                </#list>
                                                <td style="padding: 8px 10px;"><a
                                                            href="/admin/branch/${branche.getId()}"
                                                            class="badge badge-success">View</a><a
                                                            href="/admin/branch/${branche.getId()}/delete"
