                                ...
                                <div id="example_wrapper_2" class="dataTables_wrapper no-footer">
                                        ...
                                        <#list services as service>
                                            <tr role="row" class="odd" style="border-bottom: 2px solid #E7EDF6;">
                                                <td class="sorting_1" style="padding: 8px 10px;"
                                                    text="${service.getName()}">${service.getName()}</td>
                                                <td style="padding: 8px 10px;"
                                                    text="${service.getPrice()}">${service.getPrice()}</td>
                                                <td style="padding: 8px 10px;"><a
                                                            href="/admin/service/${service.getId()}"
                                                            class="badge badge-success">View</a><a
                                                            href="/admin/service/${service.getId()}/delete"
                                    ...
                                    <div class="dataTables_paginate paging_simple_numbers" id="example_paginate"
                                        ...
                                        <#list 1..totalPages as p>
                                            <#if p != currentPage >
                                                <a href="/admin/service/all/pageus/${p}"
                ...
                <div class="card card_border p-md-4">
                    <div class="card-body">
                        <form action="/admin/service/add" method="post">
                            ...
                            <input type="text" class="form-control login_text_field_bg input-style" name="price"
                                   placeholder="Price">
